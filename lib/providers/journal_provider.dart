...
class JournalProvider with ChangeNotifier {
  ...
  Future<void> testFirebaseConnection() async {
    try {
      // Test Firestore connection by trying to read from journal_entries collection
      await _firestore.collection('journal_entries').limit(1).get();
      print('Journal Firebase connection test successful');
    } catch (e) {
      print('Journal Firebase connection test failed: $e');
      throw Exception('Journal Firebase connection failed: $e');
    }
  }
}
