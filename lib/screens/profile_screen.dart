...
class ProfileScreen extends StatelessWidget {
            ...
            children: [
              ...
              Text(
                authProvider.user?.name ??
                    authProvider.currentFirebaseUser?.displayName ??
                    'User',
                style: GoogleFonts.poppins(
                  fontSize: 24,
              ...
              Text(
                authProvider.user?.email ??
                    authProvider.currentFirebaseUser?.email ??
                    'No email',
                style: GoogleFonts.poppins(
                  fontSize: 16,
                  color: Colors.grey[600],
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSettingItem(
                ...
                title: 'Debug Info',
                subtitle: 'View app status and test connections',
                onTap: () {
              ...
              _buildSettingItem(
                ...
                subtitle: 'Test authentication status and debug auth issues',
                onTap: () {
                  Navigator.of(context).pushNamed('/auth-status-test');
                },
              ),
            ],
          ),
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text('Daily journal reminders', style: GoogleFonts.poppins()),
              ],
            ),
            Row(
              children: [
                Checkbox(value: false, onChanged: (value) {}),
                Text('Weekly insights', style: GoogleFonts.poppins()),
              ],
            ),
            Row(
              children: [
                Checkbox(value: true, onChanged: (value) {}),
                Text('Mood tracking alerts', style: GoogleFonts.poppins()),
              ],
            ),
          ],
        ),
        ...
        content: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Checkbox(value: true, onChanged: (value) {}),
                Text('Data encryption enabled', style: GoogleFonts.poppins()),
              ],
            ),
            Row(
              children: [
                Checkbox(value: false, onChanged: (value) {}),
                Text('Share analytics data', style: GoogleFonts.poppins()),
              ],
            ),
            Row(
              children: [
                Checkbox(value: true, onChanged: (value) {}),
                Text('Auto-lock after 5 minutes', style: GoogleFonts.poppins()),
              ],
            ),
          ],
        ),
        ...
        content: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              subtitle: Text('support@dailyjournal.com'),
              onTap: () {
            ...
            ListTile(
              ...
              title: Text('Report Bug', style: GoogleFonts.poppins()),
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'User ID: ${authProvider.user?.id ?? 'Not logged in'}',
              style: GoogleFonts.poppins(),
            ),
            const SizedBox(height: 8),
            Text(
            ...
            const SizedBox(height: 8),
            Text(
              'Name: ${authProvider.user?.name ?? 'N/A'}',
              style: GoogleFonts.poppins(),
            ),
            const SizedBox(height: 8),
            Text(
              'Profile Image URL: ${authProvider.user?.profileImageUrl ?? 'N/A'}',
              style: GoogleFonts.poppins(),
            ),
            const SizedBox(height: 16),
            Text(
            ...
            const SizedBox(height: 8),
            Text(
              'Total Entries: ${journalProvider.entries.length}',
              style: GoogleFonts.poppins(),
            ),
            const SizedBox(height: 8),
            Text(
              'Recent Entries (last 5): ${journalProvider.getRecentEntries().length}',
              style: GoogleFonts.poppins(),
            ),
            const SizedBox(height: 8),
            Text(
              'Total Words: ${journalProvider.entries.map((entry) => entry.wordCount).fold(0, (sum, count) => sum + count)}',
              style: GoogleFonts.poppins(),
            ),
            const SizedBox(height: 16),
            ElevatedButton(
  ...
  Future<void> _testFirebaseConnection(BuildContext context) async {
    ...
    try {
      await authProvider.testFirebaseConnection();
      await journalProvider.testFirebaseConnection();
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
